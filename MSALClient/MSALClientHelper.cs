    ...
    public class MSALClientHelper
    {
        ...
        public async Task<IAccount> InitializePublicClientAppAsync()
        {
            ...
            this.PublicClientApplication = this.PublicClientApplicationBuilder
                ...
                //.WithRedirectUri($"https://login.microsoftonline.com/{PublicClientSingleton.Instance.MSALClientHelper.AzureAdConfig.TenantId}")
                //.WithRedirectUri($"msal{PublicClientSingleton.Instance.MSALClientHelper.AzureAdConfig.ClientId}://auth")
                .WithRedirectUri("https://api.businesscentral.dynamics.com")
#if WINDOWS
        ...
        {
#if ANDROID
            var webviewService = Application.Current.Handler.MauiContext.Services.GetService<IWebviewService>();
            ...
            this.InitializePublicClientApplicationBuilder();
            await this.InitializePublicClientAppAsync();
        }
